...
export default async function CadastrarPage({ searchParams }: { searchParams?: Promise<{ redirect?: string; erro?: string }> }) {
  ...
  return (
    <main className="min-h-screen app-shell flex items-center justify-center bg-slate-50 px-4 py-8 text-slate-900">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.12),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(168,85,247,0.08),transparent_28%)]" />

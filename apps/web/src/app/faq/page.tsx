    ...
    <StaticPage kicker="FAQ" title="Perguntas frequentes" description="Respostas rápidas sobre consulta, autenticação e planos.">
      <div className="space-y-4">
        {[
          ...
          ['Como assino um plano?', 'Abra /precos, escolha Starter, Pro ou Enterprise e conclua o pagamento na RecebeAqui.'],
          ['Posso arquivar XML automaticamente?', 'Sim. O armazenamento em nuvem de XML em R2 entra como add-on opcional e pode incluir XMLs de entrada.'],
